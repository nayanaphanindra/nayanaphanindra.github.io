...
.ctb-sec:last-child { border-bottom: none; }
.ctb-label {
  font-size: 0.75rem;
  font-weight: 800;
...
.ctb-sec p strong { color: var(--ink); font-weight: 600; }
.ctb-grid {
  display: grid;
...
.ctb-reflect p:last-child { margin: 0; }
.ctb-appx {
...
.ctb-appx:hover { border-color: var(--accent); }
.ctb-appx .ctb-anum {
  font-size: 0.72rem;
  font-weight: 800;
  letter-spacing: 0.14em;
...
.ctb-doclink:hover { border-color: var(--accent); }
.ctb-proto-wrap {
  border: 1.5px solid var(--line);
  border-radius: 8px;
  overflow: hidden;
...
.ctb-proto-text strong { color: var(--ink); font-weight: 600; }
.ctb-launch-btn {
...
.ctb-launch-btn:hover { background: #0a5a54; }
.ctb-proto-frame {
  display: none;
}
.ctb-proto-frame.open { display: block; }
.ctb-proto-frame iframe {
  width: 100%;
  height: 560px;
  border: none;
  display: block;
...
.ctb-ctrl:hover { border-color: #5dcaa5; color: #5dcaa5; }
.ctb-fs {
  display: none;
  position: fixed;
...
.ctb-fs.open { display: flex; }
.ctb-fs iframe { flex: 1; width: 100%; border: none; }
.ctb-fs-bar {
  background: #0a1829;
...
@media (max-width: 640px) {
  ...
  .ctb-hero { margin: -1rem -0.5rem 2rem; padding: 2.5rem 1.25rem 2rem; }
  .ctb-proto-frame iframe { height: 400px; }
}
</style>

<div class="ctb-hero">
  <span class="ctb-type">Portfolio · Instructional Design</span>
  <h1>Clear to Board</h1>
  <p class="ctb-sub">A performance-based compliance simulation for Port State Control Officers — designed to bridge the gap between knowing a maritime regulation and executing a judgment under pressure.</p>
</div>

<div class="ctb-sec">
  <span class="ctb-label">The Problem</span>
...
<div class="ctb-sec">
  <span class="ctb-label">Design Approach</span>
  ...
  <div class="ctb-grid">
    <div class="ctb-step">
      <span class="ctb-step-num">Octalysis — Core Drive 6</span>
    ...
    <div class="ctb-step">
      <span class="ctb-step-num">Octalysis — Core Drive 1</span>
...
<div class="ctb-sec">
  <span class="ctb-label">Build Decisions</span>
  ...
  <p>The reason: I needed to validate the consequence logic — the brain of the simulation — before investing in production. Building the logic-test first meant I could confirm the decision-making flow was sound before touching the authoring tool.</p>
  ...
  <a href="https://drive.google.com/file/d/1eWqngdlwOAUBupK_ra6EfjsTm0gdjITv/view?usp=sharing" target="_blank" rel="noopener" class="ctb-doclink">View full design document and Octalysis mapping (PDF) →</a>
</div>

<div class="ctb-sec">
  <span class="ctb-label">Try the Prototype</span>
  ...
  <div class="ctb-proto-wrap">
    <div class="ctb-proto-bar">
      <span>clear to board · html/css/js prototype</span>
      <span>4 min · port state control simulation</span>
    </div>
    <div class="ctb-proto-collapsed" id="ctb-collapsed">
      <div class="ctb-proto-text">
        <strong>Clear to Board — Live Prototype</strong><br>
        A deck inspection simulation. Find the violations before time runs out.
      </div>
      <button class="ctb-launch-btn" onclick="document.getElementById('ctb-collapsed').style.display='none';document.getElementById('ctb-frame').classList.add('open');">Launch simulation →</button>
    </div>
    <div class="ctb-proto-frame" id="ctb-frame">
      ...
      <div class="ctb-proto-ctrls">
        <span>Experiencing issues? Try fullscreen for best results.</span>
        <div style="display:flex;gap:0.5rem;">
          <button class="ctb-ctrl" onclick="document.getElementById('ctb-fs').classList.add('open');document.getElementById('ctb-fs-iframe').src='https://nayanaphanindra.github.io/prototype/clear-to-board.html';document.body.style.overflow='hidden';">Fullscreen</button>
          <button class="ctb-ctrl" onclick="document.getElementById('ctb-frame').classList.remove('open');document.getElementById('ctb-collapsed').style.display='flex';">Collapse</button>
        </div>
      </div>
    </div>
  </div>
...
<div class="ctb-fs" id="ctb-fs">
  <div class="ctb-fs-bar">
    <span>Clear to Board · Port State Control Simulation</span>
    <button class="ctb-ctrl" onclick="document.getElementById('ctb-fs').classList.remove('open');document.getElementById('ctb-fs-iframe').src='';document.body.style.overflow='';">Exit Fullscreen</button>
  </div>
  <iframe id="ctb-fs-iframe" src="" title="Clear to Board fullscreen" allowfullscreen></iframe>
</div>

<div class="ctb-sec">
  <span class="ctb-label">The Vision</span>
...
<div class="ctb-sec">
  <span class="ctb-label">Behind the Build</span>
...
<div class="ctb-sec">
  ...
  <div class="ctb-appx">
    <span class="ctb-anum">Source 02</span>
  ...
  <div class="ctb-appx">
    <span class="ctb-anum">Source 03</span>
    <h3>Washington State Dept. of Ecology — Cargo and Passenger Vessel Boarding Checklist</h3>
  ...
  <div class="ctb-appx">
    <span class="ctb-anum">Source 04</span>
    <h3>International Maritime Organization — Port State Control Overview</h3>
    <p>IMO overview of the PSC regime, covering the regulatory framework, regional MoUs, and conventions PSC officers inspect against — SOLAS, MARPOL, STCW, MLC 2006.</p>
